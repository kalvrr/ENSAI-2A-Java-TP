...
public class Password {
     ...
     * @return te 6-dihgit number that matches, or null if no match is found
     */
    public static String bruteForce6Digit(String targetHash) {

        // Code here
        // tester toutes les combinaisons où hash (num) == target hash
    ...
    public static HashMap<String, Boolean> checkPasswordsList(ArrayList<String> passwords) {
        ...
        // Code here
        HashMap<String, Boolean> passwordValidity = new HashMap<>();
        for (String password : passwords) {
            passwordValidity.put(password, isStrongPassword(password));
        }
